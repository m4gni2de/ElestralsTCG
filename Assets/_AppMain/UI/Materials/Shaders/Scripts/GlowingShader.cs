...
[ExecuteInEditMode]
[AddComponentMenu("CustomShader/Glowing")]
[System.Serializable]
public class GlowingShader : MonoBehaviour
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(GlowingShader)), CanEditMultipleObjects]
public class GlowingShaderEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        GlowingShader glowingShader = (GlowingShader)target;
        ...
        if (glowingShader.ForceMaterial == null)
        {
            glowingShader.ActiveChange = true;
        }
        else
        {
            if (GUILayout.Button("Remove Shared Material"))
            {
                glowingShader.ForceMaterial = null;
                glowingShader.ShaderChange = 1;
                glowingShader.ActiveChange = true;
                glowingShader.CallUpdate();
            }

            EditorGUILayout.PropertyField(m_object.FindProperty("ActiveChange"), new GUIContent("Change Material Property", "Change The Material Property"));
        }

        if (glowingShader.ActiveChange)
        {
